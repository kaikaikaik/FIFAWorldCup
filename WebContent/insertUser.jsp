...
<html>
	...
	<body>
		<div class="container">
			...
			<h2 class="page-header">添加用户信息</h2>
			<center>
			...
			<form id="form1" class="form-horizontal" action="insertUser" method="post">
				...
				<div class="form-group">
					...
					<div class="col-md-10">
						<input id="uUser" name="uUser" type="text" placeholder="请输入用户名" class="form-control" onchange="checkName()" />
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">密码</label>
					<div class="col-md-10">
						<input id="uPwd" name="uPwd" type="text" placeholder="请输入密码" onchange="checkPwd()" class="form-control" />
					</div>
				</div>
				<div class="form-group">

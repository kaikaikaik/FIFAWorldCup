	  ...
	  <div class="bg_top_h_tile">
	    <div class="bg_top_owner">
	      <div class="bg_bottom_h_tile">	      
			...
			<span style="font-size: 50px;">我关注的球队</span>
		...
		<script>
			...
			function getData() {
				$.getJSON('queryFollowGame', function(data) {
					...
					$.each(list, function(index, item) {
						...
						html += '	<td>';
						html += '		<input type="button"   class="btn btn-danger btn-sm"  onClick="unFollowGame(' + item.gId + ')" value="取消关注"/>';

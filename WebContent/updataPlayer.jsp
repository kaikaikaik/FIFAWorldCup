						...
						<div id="SUBD1526869985062680">
							...
							<div class="name">
								<div class="brief" id="playerdata">
									...
									<form id="form1" class="form1" action="updatePlayerById" method="post">
									<input type="hidden" name="pId" id="pId" value="${player.pId}"/>
									<table class="table1">
										<tr>
											<td>球星：</td>
											<td><input id="pName" name="pName" type="text" onchange="checkName()" value="${player.pName}"/></td>
										</tr>
										<tr>
											<td>球队：</td>
											<td><input id="pTname" name="pTname" type="text" onchange="checkTName()" value="${player.pTname}"/></td>
										</tr>
										<tr>
											<td>出生日期：</td>
											<td>
												<input id="pBirth" name="pBirth" type="text" value="${player.pBirth}" placeholder="出生日期"  />
											</td>
										</tr>
										<tr>
											<td>身高：</td>
											<td><input id="pHeight" name="pHeight"  onchange="checkHeight()" value="${player.pHeight}" type="text"/></td>
										</tr>
										<tr>
											<td>体重：</td>
											<td><input id="pWeight" name="pWeight"  onchange="checkWeight()" value="${player.pWeight}" type="text"/></td>
										</tr>
										<tr>
											<td>球衣号：</td>
											<td><input id="pNumber" name="pNumber"  onchange="checkNumber()" value="${player.pNumber}" type="text"/></td>
										</tr>
										<tr>
											<td>场上位置：</td>
											<td>
										...
										<tr>
											<td>修改图片</td>
											<td>
												<textarea id="pPic" name="pPic" style="margin-left:50px;" rows="5" cols="20"></textarea>
											</td>
										</tr>
										<tr>
											<td></td>
										...
										<tr>
											<td><input type="submit" value="修改" id="addBtn" /></td>

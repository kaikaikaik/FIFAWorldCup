...
<html>
	...
	<body>
		<div class="container">
			...
			<h2 class="page-header">修改用户信息</h2>
			<center>
			...
			<form id="form1" class="form-horizontal" action="updataUserById" method="post">
				<input type="hidden" name="uId" id="uId" value="${user.uId}"/>
				<input type="hidden" name="uPic" id="uPic" />
				<div class="form-group">
					<label for="" class="col-md-2">用户名</label>
					<div class="col-md-10">
						<input id="uUser" name="uUser" type="text" placeholder="${user.uUser}" class="form-control" onchange="checkName()" />
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">密码</label>
					<div class="col-md-10">
						<input id="uPwd" name="uPwd" type="text" placeholder="${user.uPwd}" onchange="checkPwd()" class="form-control" />
					</div>
				</div>
				<div class="form-group">
					<label for="" class="col-md-2">确认密码</label>
					<div class="col-md-10">
						<input id="uPwd2" name="uPwd2" type="text" placeholder="请再次输入密码" onchange="checkPwd2()" class="form-control" />
					</div>
				</div>
				<div class="form-group">

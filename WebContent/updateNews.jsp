...
<html>
	...
	<body>
		<div class="container">
			...
			<form id="form1" class="form-horizontal" action="updateNewsById" method="post">
				...
				<div class="form-group">
					<label for="" class="col-md-2">新闻事件</label>
					<div class="col-md-10">
						<input id="ninfo" name="ninfo" type="text" placeholder="简述新闻事件" class="form-control" onchange="checkInfo()"/>
					</div>
				</div>
				
				<div class="form-group">
					<div class="col-md-10 col-md-offset-2">
						<input type="submit" value="更改" class="btn btn-success" id="addBtn" />
